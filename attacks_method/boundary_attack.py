# modified by attack as defense 
# add return info: iters
# add param: th_aasd
# add early stop confition
...
class BoundaryAttack(Attack):
    ...
    * optional multithreading for candidate point generation
    ...
    def __call__(
            ...
            verbose=False,
            th_aasd=2e-02 # threshold = 5e-05 for cifar
            ):
        ...
        for step in range(1, iterations + 1):
            ...
            if new_perturbed is not None:
                if not new_distance < distance:
                    ...
                    # attack as defense: check the distance and early stop
                    if new_distance.value < self.th_aasd:
                        gl_var.return_iter_dba = step
                        break
